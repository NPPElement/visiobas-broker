...
#$JBOSS_HOME/bin/jboss-cli.sh --connect --command="module add --name=com.mysql.driver  --dependencies=javax.api,javax.transaction.api --resources=/opt/jboss/wildfly/modules/system/layers/base/com/mysql/driver/main/mysql-connector-java-5.1.46.jar" && \
